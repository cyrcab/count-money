...
import "../../Css/CarouselRssFlux.css";
import raccoon from "../../assets/raccoon.jpg";

const CarouselRssFlux: React.FC = () => {
    ...
    return (
        <Carousel className="Showcase" animation="slide" autoPlay={true} swipe={false} interval={10000} duration={400} indicators={false} navButtonsAlwaysVisible={true} NextIcon="" PrevIcon="" >
    ...
    export default CarouselRssFlux;